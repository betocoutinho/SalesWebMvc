...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", 2400.0, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", 6000.0, new DateTime(1993, 11, 30), d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", 4000.0, new DateTime(2000, 1, 9), d3);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", 3600.0, new DateTime(1997, 3, 4), d2);
